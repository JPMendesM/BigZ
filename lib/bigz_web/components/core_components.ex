defmodule BigzWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: BigzWeb.Gettext
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(BigzWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(BigzWeb.Gettext, "errors", msg, opts)
    end
  end
